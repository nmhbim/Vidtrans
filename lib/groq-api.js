    ...
    const response = await fetch(`${this.baseUrl}/chat/completions`, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Bạn là thông dịch viên cabin. Dịch cực ngắn gọn, súc tích, chuyên nghiệp từ ${source} sang tiếng Việt. CHỈ trả về bản dịch, KHÔNG giải thích, KHÔNG lặp lại câu gốc.`
          },
